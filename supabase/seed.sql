...
insert into tasks (id, project_id, title, description, category, assignee_id, status, due_date, created_by, completed_at) values
  ...
  ('d0000004-0000-0000-0000-000000000004', 'a1111111-1111-1111-1111-111111111111', 'Write service pages copy',     'SEO-optimised copy for each core service.',                'content', '55555555-5555-5555-5555-555555555555', 'uploaded',    '2026-06-02', '22222222-2222-2222-2222-222222222222', null),
...
insert into activity_log (actor_id, entity_type, entity_id, action, meta, created_at) values
  ...
  ('55555555-5555-5555-5555-555555555555', 'task', 'd0000004-0000-0000-0000-000000000004', 'status_changed', '{"from":"in_progress","to":"uploaded","title":"Write service pages copy"}', now() - interval '1 day'),
